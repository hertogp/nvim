...
local EasyQuitTable = {["help"] = true, ["man"] = true, ["nofile"] = true, ["quickfix"] = true, ["loclist"] = true, ["prompt"] = true}
...
api.nvim_create_autocmd("BufWritePost", {pattern = {"*.ex", "*.exs"}, group = auElixir, command = [[silent :MixFormat]]})
