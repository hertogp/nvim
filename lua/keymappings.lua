...
nmap('<m-j>', 'i\<esc>', opts)
-- TODO: get rid of autocompletions when pressing <cr>, see nvim-cmp configs
...
-- save & redo/undo
imap('jj', '<esc>', opts)
nmap('r', '<c-r', opts) -- u is already undo
imap('<c-s>', '<cmd>update<cr>', opts)
...
nmap('<leader>ev', '<cmd>edit ~/.config/nvim/init.vim<cr>', opts)
nmap('<leader>sv', '<cmd>source ~/.config/nvim/init.vim<cr>', opts)
